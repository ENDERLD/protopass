...
class LocalPath final :
 ...
 public:
  ...
  enum : int {
    ...
    kNavigationsFieldNumber = 4,
    kVehicleStatesFieldNumber = 5,
  ...
  ::autonomous_proto::Navigation* mutable_navigations(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::autonomous_proto::Navigation >*
      mutable_navigations();
  private:
  const ::autonomous_proto::Navigation& _internal_navigations(int index) const;
  ::autonomous_proto::Navigation* _internal_add_navigations();
  public:
  const ::autonomous_proto::Navigation& navigations(int index) const;
  ::autonomous_proto::Navigation* add_navigations();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::autonomous_proto::Navigation >&
      navigations() const;

  // repeated .autonomous_proto.VehicleState vehicle_states = 5;
  int vehicle_states_size() const;
  private:
  int _internal_vehicle_states_size() const;
  public:
  void clear_vehicle_states();
  ::autonomous_proto::VehicleState* mutable_vehicle_states(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::autonomous_proto::VehicleState >*
      mutable_vehicle_states();
  private:
  const ::autonomous_proto::VehicleState& _internal_vehicle_states(int index) const;
  ::autonomous_proto::VehicleState* _internal_add_vehicle_states();
  public:
  const ::autonomous_proto::VehicleState& vehicle_states(int index) const;
  ::autonomous_proto::VehicleState* add_vehicle_states();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::autonomous_proto::VehicleState >&
      vehicle_states() const;
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::autonomous_proto::Navigation > navigations_;
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::autonomous_proto::VehicleState > vehicle_states_;
...
inline const ::PROTOBUF_NAMESPACE_ID::DoubleValue& LocalPath_Point::lat() const {
  // @@protoc_insertion_point(field_get:autonomous_proto.LocalPath.Point.Expected_path_lat)
...
inline void LocalPath_Point::unsafe_arena_set_allocated_lat(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:autonomous_proto.LocalPath.Point.Expected_path_lat)
}
...
inline ::PROTOBUF_NAMESPACE_ID::DoubleValue* LocalPath_Point::unsafe_arena_release_lat() {
  // @@protoc_insertion_point(field_release:autonomous_proto.LocalPath.Point.Expected_path_lat)
...
inline ::PROTOBUF_NAMESPACE_ID::DoubleValue* LocalPath_Point::mutable_lat() {
  ...
  // @@protoc_insertion_point(field_mutable:autonomous_proto.LocalPath.Point.Expected_path_lat)
  return _msg;
}
inline void LocalPath_Point::set_allocated_lat(::PROTOBUF_NAMESPACE_ID::DoubleValue* lat) {
  ...
  _impl_.lat_ = lat;
  // @@protoc_insertion_point(field_set_allocated:autonomous_proto.LocalPath.Point.Expected_path_lat)
}
...
inline const ::PROTOBUF_NAMESPACE_ID::DoubleValue& LocalPath_Point::lon() const {
  // @@protoc_insertion_point(field_get:autonomous_proto.LocalPath.Point.Expected_path_lon)
...
inline void LocalPath_Point::unsafe_arena_set_allocated_lon(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:autonomous_proto.LocalPath.Point.Expected_path_lon)
}
...
inline ::PROTOBUF_NAMESPACE_ID::DoubleValue* LocalPath_Point::unsafe_arena_release_lon() {
  // @@protoc_insertion_point(field_release:autonomous_proto.LocalPath.Point.Expected_path_lon)
...
inline ::PROTOBUF_NAMESPACE_ID::DoubleValue* LocalPath_Point::mutable_lon() {
  ...
  // @@protoc_insertion_point(field_mutable:autonomous_proto.LocalPath.Point.Expected_path_lon)
  return _msg;
}
inline void LocalPath_Point::set_allocated_lon(::PROTOBUF_NAMESPACE_ID::DoubleValue* lon) {
  ...
  _impl_.lon_ = lon;
  // @@protoc_insertion_point(field_set_allocated:autonomous_proto.LocalPath.Point.Expected_path_lon)
}
...
inline const ::PROTOBUF_NAMESPACE_ID::DoubleValue& LocalPath_Point::alt() const {
  // @@protoc_insertion_point(field_get:autonomous_proto.LocalPath.Point.Expected_path_alt)
...
inline void LocalPath_Point::unsafe_arena_set_allocated_alt(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:autonomous_proto.LocalPath.Point.Expected_path_alt)
}
...
inline ::PROTOBUF_NAMESPACE_ID::DoubleValue* LocalPath_Point::unsafe_arena_release_alt() {
  // @@protoc_insertion_point(field_release:autonomous_proto.LocalPath.Point.Expected_path_alt)
...
inline ::PROTOBUF_NAMESPACE_ID::DoubleValue* LocalPath_Point::mutable_alt() {
  ...
  // @@protoc_insertion_point(field_mutable:autonomous_proto.LocalPath.Point.Expected_path_alt)
  return _msg;
}
inline void LocalPath_Point::set_allocated_alt(::PROTOBUF_NAMESPACE_ID::DoubleValue* alt) {
  ...
  _impl_.alt_ = alt;
  // @@protoc_insertion_point(field_set_allocated:autonomous_proto.LocalPath.Point.Expected_path_alt)
}
...
// repeated .autonomous_proto.Navigation navigations = 4;
inline int LocalPath::_internal_navigations_size() const {
  return _impl_.navigations_.size();
}
inline int LocalPath::navigations_size() const {
  return _internal_navigations_size();
}
inline ::autonomous_proto::Navigation* LocalPath::mutable_navigations(int index) {
  // @@protoc_insertion_point(field_mutable:autonomous_proto.LocalPath.navigations)
  return _impl_.navigations_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::autonomous_proto::Navigation >*
LocalPath::mutable_navigations() {
  // @@protoc_insertion_point(field_mutable_list:autonomous_proto.LocalPath.navigations)
  return &_impl_.navigations_;
}
inline const ::autonomous_proto::Navigation& LocalPath::_internal_navigations(int index) const {
  return _impl_.navigations_.Get(index);
}
inline const ::autonomous_proto::Navigation& LocalPath::navigations(int index) const {
  // @@protoc_insertion_point(field_get:autonomous_proto.LocalPath.navigations)
  return _internal_navigations(index);
}
inline ::autonomous_proto::Navigation* LocalPath::_internal_add_navigations() {
  return _impl_.navigations_.Add();
}
inline ::autonomous_proto::Navigation* LocalPath::add_navigations() {
  ::autonomous_proto::Navigation* _add = _internal_add_navigations();
  // @@protoc_insertion_point(field_add:autonomous_proto.LocalPath.navigations)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::autonomous_proto::Navigation >&
LocalPath::navigations() const {
  // @@protoc_insertion_point(field_list:autonomous_proto.LocalPath.navigations)
  return _impl_.navigations_;
}

// repeated .autonomous_proto.VehicleState vehicle_states = 5;
inline int LocalPath::_internal_vehicle_states_size() const {
  return _impl_.vehicle_states_.size();
}
inline int LocalPath::vehicle_states_size() const {
  return _internal_vehicle_states_size();
}
inline ::autonomous_proto::VehicleState* LocalPath::mutable_vehicle_states(int index) {
  // @@protoc_insertion_point(field_mutable:autonomous_proto.LocalPath.vehicle_states)
  return _impl_.vehicle_states_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::autonomous_proto::VehicleState >*
LocalPath::mutable_vehicle_states() {
  // @@protoc_insertion_point(field_mutable_list:autonomous_proto.LocalPath.vehicle_states)
  return &_impl_.vehicle_states_;
}
inline const ::autonomous_proto::VehicleState& LocalPath::_internal_vehicle_states(int index) const {
  return _impl_.vehicle_states_.Get(index);
}
inline const ::autonomous_proto::VehicleState& LocalPath::vehicle_states(int index) const {
  // @@protoc_insertion_point(field_get:autonomous_proto.LocalPath.vehicle_states)
  return _internal_vehicle_states(index);
}
inline ::autonomous_proto::VehicleState* LocalPath::_internal_add_vehicle_states() {
  return _impl_.vehicle_states_.Add();
}
inline ::autonomous_proto::VehicleState* LocalPath::add_vehicle_states() {
  ::autonomous_proto::VehicleState* _add = _internal_add_vehicle_states();
  // @@protoc_insertion_point(field_add:autonomous_proto.LocalPath.vehicle_states)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::autonomous_proto::VehicleState >&
LocalPath::vehicle_states() const {
  // @@protoc_insertion_point(field_list:autonomous_proto.LocalPath.vehicle_states)
  return _impl_.vehicle_states_;
}
